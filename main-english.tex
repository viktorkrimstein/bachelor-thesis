...
\begin{document}
	...
	\chapter{State of the Art} \label{ch:state_of_the_art}
		...
		\section{Technology} \label{sec:technology}
			...
			Show currently state of technologies. Include references to current standard specifications.
				...
				\subsection{Software in the Production Environment} \label{subsec:software_in_the_production_environment}
	...
	\chapter{State of the Science} \label{ch:state_of_the_Science}
		...
		\section{Industry 4.0}\label{sec:industry_4}
		
			Summary over the following papers:
			
			\begin{itemize}
				
				\item Cloud Computing~\cite{mell2011nist}
