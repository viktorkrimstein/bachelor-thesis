...
\begin{document}
	...
	\chapter{Foundations}\label{ch:foundations}
		...
		\section*{Conclusion}\label{sec:foundations_conclusion}
			...
			This section provided a brief introduction to the \gls{rnp} research project platform as well as to further related fields of this work.
			\gls{rnp} was presented as vendor independent \gls{cm} platform, which currently lacks the functionalities to bind and control machine tools from the Cloud. General Cloud Computing concepts as \gls{saas} have been highlighted in parallel to their relations and influence to the \gls{cm} field. Respectively to the \gls{cm} and manufacturing and control scopes in general, \gls{opcua} protocol, emerging in Europe has been presented as well. Possibilities, which come with \gls{opcua} and their relation to this thesis, which aims to evaluate and provide a \gls{poc} for production data transfer to machine tools from the cloud and being machine tool and control independent at the same time, have been presented as well.
