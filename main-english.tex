...
\begin{document}
	...
	\chapter{Introduction} \label{ch:introduction}
		...
		\section{Motivation}\label{sec:motivation}
			...
			Currently the most Use Cases of existing \gls{cm} platforms focus on the retrieval and gathering of data from machine tools.
	...
	\newpage
		...
		\section{Structure}
			...
			\Cref{ch:evaluation} then describes the evaluation of a suitable Open Source \gls{opcua} framework for the implementation of the \gls{poc}.
	...
	\chapter{Foundations}\label{ch:foundations}
		...
		\section{Open Platform Communications Unified Architecture} \label{sec:opc_ua}
			...
			\subsection{Client Model}\label{subsec:opc_ua_client_model}
	...
	\chapter{State of the Art}\label{ch:state_of_the_art}
		...
		In this chapter this work covers the state-of-the-art concepts and technologies being used for the evaluation, implementation and integration of the \gls{poc}. \Cref{sec:spring_boot} introduces the Spring Boot framework for \gls{java}~\cite{java2015} programming language. In \cref{sec:docker} the trending virtualization container technology Docker is highlighted. Finally, the \gls{rest} concept for \gls{api} design is covered by \cref{sec:rest}
		...
		\section{Container-Based Virtualization}\label{sec:docker}
			...
			\begin{figure}[H]
				...
				\begin{subfigure}{0.45\textwidth}
					...
					\caption{A diagram showing the layers of a hypervisor-based virtualization}
